...
function ResultsView({ result, onBack, appliedPreset, presetModified, purityLevels, productDescriptions, currentFlow, onFlowChange }) {
    ...
    useEffect(() => {
        ...
        const updateLineWidth = () => {
            ...
            setLineLeft(first.left - containerRect.left + container.scrollLeft + first.width / 2);
        };
    ...
    return (
        <div className="space-y-6">
            <div className="bg-white overflow-hidden shadow-sm sm:rounded-2xl">
                <div className="p-6">
                    <div className="mb-4">
                        <table className="w-full border-collapse overflow-hidden rounded-lg md:table-fixed">
                            <thead>
                        ...
                        <div className="p-6">
                            ...
                            <div>
                                <div className="relative">
                                    <div ref={flowContainerRef} className="flex items-start justify-start md:justify-center gap-3 overflow-x-auto pb-4 relative">
                                        {lineWidth > 0 && (
                                            <div className="absolute top-[60px] h-0.5 bg-gray-400 z-0" style={{
                                                width: `${lineWidth}px`,
                                                left: `${lineLeft}px`
                                            }}></div>
                                        )}
